...
export function Partners() {
  return (
    <div className="bg-gray-100 rounded p-6 sm:p-10 mx-4 sm:mx-8 md:mx-12 lg:mx-0">
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold capitalize mt-6 sm:mt-10">
        our partners<span className="text-blue-100">_______________________________</span></h1>
